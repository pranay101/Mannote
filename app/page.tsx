...
export default function Home() {
  return (
   <main className='h-full w-screen bg-white text-black relative -mt-36'>
        ...
        <span className='text-8xl font-bold text-gray-900'>Mann-Note</span>
        ...
        <div className='border-t h-20 w-full absolute bottom-0 left-0 flex justify-between text-sm text-gray-500 items-center px-24'>
            <span>
